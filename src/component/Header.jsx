...
const Header = () => {
  return (
    ...
    <div className='flex gap-8 items-center'>
        <button className='bg-[#f54748] active:scale-90 transition duration-500 tranform hover:shadow-xl shadow-full  rounded-full px-8 py-2 text-xl font-medium text-white'>explore now</button>
    ...
    <div className='h-14 w-14 shadow-md cursor-pointer relative bg-white rounded-full'>
        <FaPlay size={18} className='cursor-pointer text-[#f54748] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'/></div>
        <div className='lg:text-xl text-[#191919] md:text-lg text-base cursor-pointer'>watch now</div>
    </div>
        </div>
    </div>
   <img src="https://img.freepik.com/free-photo/young-adults-enjoying-food_23-2149303580.jpg" alt="" className='h-[28rem] mx-auto justify-end rounded-xl m-5 p-5'/>
        </div>
    </div>
      </div>
