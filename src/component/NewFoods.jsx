...
const NewFoods = () => {
  return (
    <div className='py-3 px-10 sm:px-px-4 md:px-6 lg:px-6'>
    ...
    <div className='food-card bg-red-500/10 rounded-xl  flex flex-col cursor-pointer items-center p-5'>
        <div className='relative mb-3'>
            <img src='https://j6e2i8c9.rocketcdn.me/wp-content/uploads/2021/05/Eggless-Black-forest-Pastry-recipe-1.jpg' alt=''/>
        ...
        <div className='absolute bottom-2 right-2'>
            <button className='shadow-sm bottom-4 border-white text-black bg-[#fdc55e] cursor-pointer p-3 h-14 w-14 text-xl font-bold rounded-full relative'>
...
50 Rs.
    ...
    <div className='food-card bg-red-500/10 rounded-xl flex flex-col cursor-pointer items-center p-5'>
        <div className='relative mb-8'>
            <img src='https://www.cookinwithmima.com/wp-content/uploads/2023/04/honey-chilli-fries.jpg' alt=''/>
        <div className='absolute top-2 left-2'>
            <button className='shadow-sm text-white bg-red-500 hover:bg-red-700 cursor-pointer p-5 rounded-full relative'>
                <FaHeart className='absolute text-xl top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'/>
            </button>
